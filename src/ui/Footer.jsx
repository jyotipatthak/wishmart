...
function Footer() {
  return (
    ...
    // </div>
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 bg-slate-400 mt-4 ">
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-grayshade-50">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className=" font-bold mb-2">Products</h6>
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link
                  to="#"
                  className=" dark:text-lightColor-100 hover:text-grayshade-50 transition duration-150 ease-in-out text-red"
                >
                  Integrations
                </Link>
              </li>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-grayshade-50">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-black dark:text-lightColor-100 mr-4">
